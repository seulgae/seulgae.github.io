const projects = [
  {
    ...
    achievements: [
      {
        title: "개인정보 대량 암호화 패치 및 디값 보안 강화",
        detail:
          "티빙 디값 유출 사례 인지 후 가입·인증 컬럼 암호화 선제 조치, 디아모 암복호화 솔루션 기반 CSQL nohup 백그라운드 처리로 서비스 중단 없이 대량 패치 완료",
        result: "행안부 연계 디값 10만 건·개인정보 이력 300만 건, 총 310만 건 암호화",
        references: [
          {
            text: "티빙 디값 유출 관련 보도 - JTBC",
