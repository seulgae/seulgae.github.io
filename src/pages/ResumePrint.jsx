...
const projects = [
  {
    ...
    achievements: [
      "개인정보 CI 및 이력 데이터 총 310만 건 암호화 패치를 서비스 중단 없이 완료",
      "의결기한 당일 민원인 알림톡 자동 발송 배치 신규 개발로 발송률 100%, 누락률 0% 달성",
      "보안 취약점 16건·SQL Injection 오류 14건 개선 및 Jasypt 기반 환경별 계정정보 17건 암호화 적용",
      "XSS 취약점 전수 점검으로 JSP 화면 260개 점검·217개 조치 완료 및 입출력 이중 인코딩 화면 깨짐 해소",
